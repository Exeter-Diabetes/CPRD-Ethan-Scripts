---
title: "GAD Medcode list creation"
...
search_terms = list("GAD", "glutamic acid decarboxylase", "glutamic acid", "glutamic" , "acid decarboxylase")
...
write.table(medcodelist_df, "exeter_medcodelist_gad.txt", quote=FALSE, sep = "\t", row.names=FALSE, col.names=TRUE)
```
---
title: "IA2 Medcode list creation"
...
search_terms = list("ia2", "tyrosine phosphatase", "islet tyrosine phosphatase", "islet antigen" , "islet antigen 2")
...
# Removing unwanted codes - NO UNWANTEDS
```
...
write.table(medcodelist_df, "exeter_medcodelist_ia2.txt", quote=FALSE, sep = "\t", row.names=FALSE, col.names=TRUE)
```